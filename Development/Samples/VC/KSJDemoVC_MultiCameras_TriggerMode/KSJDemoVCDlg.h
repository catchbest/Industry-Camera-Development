...
{
public:
	static VOID WINAPI PREVIEWCALLBACK(unsigned char *pImageData, int nWidth, int nHeight, int nBitCount, void *lpContext);
...
public:
	...
	afx_msg void OnBnClickedCheckSetCallback();

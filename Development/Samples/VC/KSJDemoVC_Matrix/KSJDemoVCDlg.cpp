...
void CKSJDemoVCDlg::UpdateWbmControls()
{
	...
	_stprintf_s(szMatrix, WHITE_BALANCE_RATIO_FORMAT, fMatrix[0]);
	...
	_stprintf_s(szMatrix, WHITE_BALANCE_RATIO_FORMAT, fMatrix[1]);
	...
	_stprintf_s(szMatrix, WHITE_BALANCE_RATIO_FORMAT, fMatrix[2]);
...
void CKSJDemoVCDlg::UpdateCcmControls()
{
	...
	TCHAR  szMatrix[16] = { '\0' };
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[0][0]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[0][1]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[0][2]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[1][0]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[1][1]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[1][2]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[2][0]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[2][1]);
	...
	_stprintf_s(szMatrix, COLOR_CORRECTION_FORMAT, fCcmMatrix[2][2]);
...
void CKSJDemoVCDlg::WBACallback(float fMatrix[3])
{
	...
	_stprintf_s(szWBValue, WHITE_BALANCE_RATIO_FORMAT, fRRatio);
	((CEdit*)GetDlgItem(IDC_STATIC_WBMATRIX0))->SetWindowText(szWBValue);

	_stprintf_s(szWBValue, WHITE_BALANCE_RATIO_FORMAT, fGRatio);
	((CEdit*)GetDlgItem(IDC_STATIC_WBMATRIX1))->SetWindowText(szWBValue);

	_stprintf_s(szWBValue, WHITE_BALANCE_RATIO_FORMAT, fBRatio);
...
void CKSJDemoVCDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
	...
	case IDC_SLIDER_WBMATRIX0:
		_stprintf_s(szValue, WHITE_BALANCE_RATIO_FORMAT, (float)(nValue / WHITE_BALANCE_RATIO_PRESION));
	...
	case IDC_SLIDER_GAIN00:
		_stprintf_s(szValue, COLOR_CORRECTION_FORMAT, (float)(nValue / COLOR_CORRECTION_PRESION));

...
public:
	...
	void UpdateInterfaceCompanding();
	afx_msg void OnBnClickedLutReset();
	afx_msg void OnCbnSelchangeComboLutType();
	afx_msg void OnBnClickedSavefile();
	afx_msg void OnBnClickedButtonFileDownload();
	afx_msg void OnBnClickedButtonDataDownload();
	afx_msg void OnBnClickedCheckLut();
	afx_msg void OnBnClickedCheckGammaLut();

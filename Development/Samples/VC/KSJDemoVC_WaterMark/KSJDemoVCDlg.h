...
public:
	...
	afx_msg LRESULT MsgShowWaterMark(WPARAM wParam, LPARAM lParam);
...
public:
	...
	void SetFlash();
	afx_msg void OnBnClickedCheckWatermark();
	void SetWaterMark(WaterMarkData* pWaterMarkData);
	afx_msg void OnEnChangeEditTriggerencode();
};

...
public:
	...
	afx_msg void OnEnChangeEditBadpixelCorrectionLow();
	afx_msg void OnEnChangeEditBadpixelCorrectionHigh();
	void SetThreshold();
	afx_msg void OnBnClickedCheckBadpixelCorrectionEnable();
	afx_msg void OnCbnSelchangeComboBadpixelCorrectionMode();
	void SetBadpixelCorrection();
	afx_msg void OnEnChangeEditProcessContrast();
	afx_msg void OnEnChangeEditProcessSaturation();
	afx_msg void OnEnChangeEditProcessBrightness();
	afx_msg void OnEnChangeEditProcessGamma();
	afx_msg void OnBnClickedButtonProcessReset();
	void OnInitImage();
	afx_msg void OnBnClickedCheckHueSaturationEnable();
	afx_msg void OnBnClickedButtonHueSaturationReset();
	afx_msg void OnBnClickedButtonHueSaturationSet();
	afx_msg void OnCbnSelchangeComboHueSaturationHuerange();
};

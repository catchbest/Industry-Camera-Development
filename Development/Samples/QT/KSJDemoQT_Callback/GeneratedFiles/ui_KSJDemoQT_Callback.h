...
#ifndef UI_KSJDEMOQT_CALLBACK_H
#define UI_KSJDEMOQT_CALLBACK_H
...
public:
    ...
    QPushButton *SetCallbackButton;
    QPushButton *SetCallbackExButton;
    ...
    void setupUi(QDialog *KSJDemoQT_Callback)
    {
        ...
        FunctionTableWidget->setGeometry(QRect(940, 0, 291, 561));
        ...
        SetCallbackButton = new QPushButton(KSJDemoQT_Callback);
        SetCallbackButton->setObjectName(QStringLiteral("SetCallbackButton"));
        SetCallbackButton->setGeometry(QRect(840, 250, 91, 23));
        SetCallbackExButton = new QPushButton(KSJDemoQT_Callback);
        SetCallbackExButton->setObjectName(QStringLiteral("SetCallbackExButton"));
        SetCallbackExButton->setGeometry(QRect(840, 290, 91, 23));
    ...
    void retranslateUi(QDialog *KSJDemoQT_Callback)
    {
        ...
        SetCallbackButton->setText(QApplication::translate("KSJDemoQT_Callback", "SetCallback", 0));
        SetCallbackExButton->setText(QApplication::translate("KSJDemoQT_Callback", "SetCallbackEx", 0));
    } // retranslateUi
